/*
    ...
    a través de un método constructor. Luego, en RaicesServicio las operaciones 
    que se podrán realizar son las siguientes:
        ...
        Método calcular(): esté método llamará tieneRaices() y a tieneRaíz(), y mostrará
            por pantalla las posibles soluciones que tiene nuestra ecuación con 
            los métodos obtenerRaices() o obtenerRaiz(), según lo que devuelvan 
...
*/
package extras_1_raices;

import Entidades.Raices;
import Servicios.ServiceRaices;
import java.util.Scanner;
/**
 * @author JheX
 */
public class Extras_1_raices {
    public static void main(String[] args) {
        ...
        SR.calcular(SR.tieneRaices(SR.getDiscriminante(raiz)), SR.tieneRaiz(SR.getDiscriminante(raiz)), SR.getDiscriminante(raiz), raiz);
    }
}
