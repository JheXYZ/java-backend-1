/*
    ...
    brinda a sus clientes coberturas integrales para vehículos.
    Luego de un pequeño relevamiento, te vamos a pasar en limpio los requerimientos
    del sistema que quiere realizar la empresa.
        ...
        b. Gestión de vehículos. Se registra la información de cada vehículo 
            ...
            (camioneta, sedán, etc.).
        c. Gestión de Pólizas: Se registrará una póliza, donde se guardará los 
            datos tanto de un vehículo, como los datos de un solo cliente. Los 
            datos incluidos en ella son: número de póliza, fecha de inicio y fin
            de la póliza, cantidad de cuotas, forma de pago, monto total asegurado,
            incluye granizo, monto máximo granizo, tipo de cobertura (total, contra
            terceros, etc.). Nota: prestar atención al principio de este enunciado
            y pensar en las relaciones entre clases. Recuerden que pueden ser de
...
import Servicio.ServiceClientes;
...
public class Extras_3 {
    public static void main(String[] args) {
        ...
        ServiceClientes SC = new ServiceClientes();
        boolean fin = false;
        Clientes.put(Clientes.size(),SC.nuevoCliente(Polizas));
        for (Map.Entry<Integer, Cliente> cliente : Clientes.entrySet()) {
            System.out.println("Cliente N°" + cliente.getKey());
            SC.mostrarCliente(cliente.getValue());
            System.out.println("");
        }
