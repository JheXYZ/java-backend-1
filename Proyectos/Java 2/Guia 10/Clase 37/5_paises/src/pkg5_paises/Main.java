/*
    ...
    guardará el país en el conjunto y después se le preguntará al usuario si 
    quiere guardar otro país o si quiere salir, si decide salir, se mostrará todos
    los países guardados en el conjunto. (Recordemos hacer los servicios en la 
...
public class Main {
    public static void main(String[] args) {
        ...
        TreeSet<String> Paises = SP.ingresarPaises();
