...
public class Extras_4 {
    public static void main(String[] args) {
        ...
        ArrayList<Alumno> Alumnos = Sim.crearAlumnos(Sim.crearDNIs(), Sim.crearNombresApellidos());
        Sim.mostrarAlumnos(Alumnos);
        ArrayList<Voto> Votos = Sim.votacion(Alumnos);
        Sim.mostrarVotos(Votos);
        Sim.crearFacilitadores(Alumnos);
    }
}
