/*
    ...
    Definir los siguientes métodos en AhorcadoService:
        -Metodo crearJuego(): le pide la palabra al usuario y cantidad de jugadas
            ...
            letra por letra, quedando cada letra de la palabra en un índice del 
            vector. Y también, guarda la cantidad de jugadas máximas y el valor 
        ...
        -Método encontradas(letra):  que reciba una letra ingresada por el usuario
            ...
            si la letra no estaba, ya que, cada vez que se busque una letra que 
 ...
 * @author JheX
*/
public class Extra_2_ahoracado {
    public static void main(String[] args) {
       Ahorcado ahorcado = new Ahorcado();
       ServiceAhorcado SA = new ServiceAhorcado();
       
       SA.crearJuego(ahorcado);
       SA.longitud(ahorcado);
       SA.juego(ahorcado);
    }
}
